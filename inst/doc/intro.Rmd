...
After the data collection, the information can be processed using GerminaR by the [R console](https://flavjack.github.io/GerminaR/articles/GerminaR) or using the [GerminaQuant App](https://flavjack.github.io/GerminaR/articles/GerminaQuant). 
