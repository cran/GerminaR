...
After the data collection, the information can be processed using GerminaR by the [R console](https://germinar.inkaverse.com/articles/GerminaR) or using the [GerminaQuant App](https://germinar.inkaverse.com/articles/GerminaQuant). 
