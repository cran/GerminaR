---
title: "Seed germination process"
...
vignette: >
  %\VignetteIndexEntry{Seed germination process}
...
After the data collection, the information can be processed using GerminaR by the [R console](https://germinar.inkaverse.com/articles/GerminaR) or using the [GerminaQuant](https://germinar.inkaverse.com/articles/GerminaR) app. 
